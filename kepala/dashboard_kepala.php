...
<nav class="navbar navbar-expand-lg navbar-dark nav4b">
    <div class="container-fluid">
        <span class="navbar-brand">🛡️ Kepala Keamanan — Laporan Diklat</span>
...
<div class="page-header">
    <div class="container">
        <h3>Laporan & Konfirmasi Hasil Diklat</h3>
        <p>Tinjau laporan penilaian siswa → konfirmasi selesainya periode kegiatan</p>
    </div>
</div>
